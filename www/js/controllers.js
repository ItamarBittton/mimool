...
angular.module('starter.controllers', [])
  ...
  .controller('RateCtrl', function ($scope, $stateParams, Data) {
    $scope.str = 'חפש';
    $scope.show = false;
    $scope.info = {};
    $scope.info.tm = '';
  ...
  .factory("Data", function ($http) {
    ...
    var alertMessage = function (data) {
      if (data.success) alert(data.success) //Notification.success(data.success);
      if (data.error) alert(data.error) //Notification.error(data.error);
    }
